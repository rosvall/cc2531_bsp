...
//  R/W    ADC interrupt flag. Set to 1 when ADC interrupt occurs and cleared when CPU # H0     vectors to the interrupt service routine. # 0: Interrupt not pending # 1: Interrupt pending
...
#define ADCCON1_RCTRL_NORMAL (0U<<2) // Normal operation. (13* unrolling) 
#define ADCCON1_RCTRL_ONCE (1U<<2) // Clock the LFSR once (13* unrolling) 
...
#define ADCCON1_ST BIT(6)     // (reset=0 R/W1/) Start conversion. Read as 1 until conversion has completed # H0 
...
// AIN4-AIN5 
#define ADCCON2_SCH_AIN4_MINUS_AIN5 (10U<<0)
// AIN6-AIN7 
#define ADCCON2_SCH_AIN6_MINUS_AIN7 (11U<<0)
// GND 
#define ADCCON2_SCH_GND (12U<<0)
// Temperature sensor 
#define ADCCON2_SCH_TEMP_SENSOR (14U<<0)
// VDD / 3
#define ADCCON2_SCH_VDD_DIV_3 (15U<<0)
...
// AIN4-AIN5 
#define ADCCON3_ECH_AIN4_MINUS_AIN5 (10U<<0)
// AIN6-AIN7 
#define ADCCON3_ECH_AIN6_MINUS_AIN7 (11U<<0)
// GND 
#define ADCCON3_ECH_GND (12U<<0)
// Temperature sensor 
#define ADCCON3_ECH_TEMP_SENSOR (14U<<0)
// VDD / 3
#define ADCCON3_ECH_VDD_DIV_3 (15U<<0)
